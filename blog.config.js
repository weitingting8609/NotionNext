...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '哈喽，我们是一个喜欢记录自己生活的人，欢迎来到我的博客',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '未未与末末', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '忧愁善感的孩子', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.zhouyuhan.net/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '学生作文, 作家', // 网站关键词 英文逗号隔开
  ...
  // 侧栏布局 是否反转(左变右,右变左) 已支持主题:  next medium fukasawa example
